...
반드시 이 구조로 작성:
[1문단] 자기 소개 + 실제로 한 일 (수치 포함, 2~3문장)
[2문단] 채용공고의 담당업무 또는 우대사항 중 1~2개를 직접 언급하고, 내 경험을 구체적으로 연결 (2~3문장)
[3문단] 입사 후 이 회사에서 구체적으로 어떤 문제를 풀고 싶은지 짧게 (1~2문장)

작성 규칙:
- "안녕하세요"로 시작
- 경력 표기: "{year_level} 개발자" 형태만, 개월수 언급 금지
- 문단 사이 빈 줄(\\n\\n)로 구분
- 문단당 2~3문장, 전체 300자 내외
- 기술명과 수치 반드시 포함

절대 쓰지 말 것:
- "역량", "경험을 살려", "실력", "능력", "역량을 발휘"
- "~에 익숙하며", "~을 바로 적용하겠습니다", "~을 극대화하겠습니다", "~을 풀어내겠습니다"
- "~을 바탕으로", "~을 통해 기여", "함께하겠습니다", "함께 성장"
- "~에 자신 있습니다", "~에 강점이 있습니다", "~이 연결된다고 생각해"
- 과도한 다짐·포부, 채용공고 문구를 그대로 반복하기
...
{company_name}의 [담당업무 항목 직접 언급] 업무를 보고 지원했습니다. 큐텐테크놀로지에서 Kafka로 주문 이벤트를 비동기 처리했고, Redis로 캐싱을 구성해 [우대사항 항목 직접 언급] 경험이 있습니다.

입사 후에는 [이 회사의 구체적 시스템]에서 [구체적 문제]를 [구체적 방법]으로 개선해보고 싶습니다." """
