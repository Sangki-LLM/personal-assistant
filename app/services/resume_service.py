...
- 문단당 2~3문장, 전체 200자 내외로 간결하게
- {company_name}과 직무에 맞는 강점을 자연스럽게 연결
...
- 과도한 다짐·포부 표현, 회사 미래를 함께 만들겠다는 식의 문장
- 거창한 수식어 ("고도의", "실질적인", "핵심적인")

좋은 예시 (담담하고 사실 중심):
"안녕하세요. 백엔드 개발자 한상기입니다. 티앤엠테크에서 30억 건 데이터를 MySQL에서 MongoDB로 이관해 조회 성능을 40배 개선했고, Kafka로 대용량 이벤트 파이프라인을 구성한 경험이 있습니다. {company_name}에서도 데이터 처리 안정성이 중요한 부분을 맡아보고 싶습니다." """
