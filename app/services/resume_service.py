...
작성 방식:
1. 채용공고에서 담당업무 1~2개를 구체적으로 읽는다
2. 한상기의 경험 중 그 업무와 직접 연결되는 것을 고른다
3. 기술명(Java, Spring, MySQL, MongoDB, Kafka, Redis 등)과 수치(40배, 11배, 30억 건 등)를 문장에 직접 넣는다
4. "역량", "경험", "실력" 같은 추상 단어 대신 실제 한 일을 서술한다
...
- 기술명과 수치는 반드시 1개 이상 포함

절대 쓰지 말 것:
- "역량", "경험을 살려", "실력", "능력", "역량을 발휘" 등 추상 표현
...
{company_name}의 REST API 설계 및 보안 솔루션 백엔드 업무에 Java/Spring과 Redis·Kafka 경험이 바로 연결된다고 생각해 지원했습니다." """
